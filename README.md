...
% mkdir -p microros
% pushd microros
% git clone ssh://git@se-ies1-repo.esol.co.jp:29503/researchanddevelopment/ros_sdk_group/thirdparty/micro_ros_setup.git -b rmw_zenoh_pico src/micro_ros_setup
% popd 
```
...
``` 
% git clone ssh://git@se-ies1-repo.esol.co.jp:29503/researchanddevelopment/ros_sdk_group/sandbox/rmw_zenoh_pico
